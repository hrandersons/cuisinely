        ...
        <div className="col s12 m10">
          <div className="card">
            ...
            <div className="card-content">
              <span className="card-title activator grey-text text-darken-4">Pork Ramen<i className="material-icons right">shopping_cart</i></span>
              <br />
              <p>Directions:</p>
              <p>
        ...
        <div class="col s12 m10">
          <div class="card">
            <div class="card-image waves-effect waves-block waves-light">
              <img class="activator" src="https://search.chow.com/thumbnail/1280/800/www.chowstatic.com/assets/2014/11/31178_slow_cooker_pork_ramen_3000.jpg" />
            </div>
            <div class="card-content">
              <span class="card-title activator grey-text text-darken-4">Pork Ramen<i class="material-icons right">shopping_cart</i></span>
              <br />
              <p>Directions:</p>
              <p>
                  1. Put a large sauté pan or the flameproof insert of a slow cooker on the stove top over medium-high heat, then add the oil and warm until hot. Working in batches if necessary to avoid crowding, add the pork pieces and sear them on the first side without moving them until well browned, 3 to 4 minutes. Turn the pieces and sear on the second side until well browned, 3 to 4 minutes longer. Transfer to a plate and set aside.
              ...
              <div class="fixed-action-btn horizontal click-to-toggle">
                ...
                <ul>
                  ...
                  <li><a class="btn-floating green"><i class="material-icons">local_printshop</i></a></li>
                  <li><a class="btn-floating pink"><i class="material-icons">favorite</i></a></li>
                  <li><a class="btn-floating cyan"><i class="material-icons">add</i></a></li>
                </ul>
              </div>
            </div>
...
>>>>>>> prelim layout for recipe detail page
                <thead>
                  <tr>
                    <th>Item Name</th>
                    <th>Item Amount</th>
